          ...
          <div className="flex w-full flex-col gap-4 border-b border-[#f5f5f5] pb-6">
            ...
            <div className="flex flex-col gap-2">
              <p className="text-[#5c5c5c]">
                Привет! Я Евгений, делаю мобильные интерфейсы. Мне важно,
                чтобы в продукте всё было на своих местах.
              </p>
              <p className="text-[#5c5c5c]">
                Сейчас осваиваю дизайн-инженерию. Собираю макеты в код,
                анимирую интерфейсы, делаю интерактивные штуки.
              </p>
            </div>
          </div>
