...
export const metadata: Metadata = {
  ...
  description:
    "Небольшая тулза для учёта подписок: AI-сервисы, экосистемы вроде Яндекса или Сбера.",
};
        ...
        <div className="content flex w-full flex-col items-center gap-6">
          <div className="flex w-[480px] max-w-full flex-col gap-4 border-b border-[#f5f5f5] pb-6">
            ...
            <p className="text-[#5c5c5c]">
              ...
              Яндекса или Сбера. Показывает все активные подписки в одном
              месте и сколько в сумме набегает на них за месяц, а новую
