...
const benchmarkIcons = [
  {
    ...
    alt: "Яндекс Музыка",
    tip: "Перейти к артисту можно прямо из трека, даже если их несколько. Но при подписке меняется только иконка, ценность не объясняется, и связи с уведомлениями о релизах нет.",
  },
  {
    name: "apple-music",
    icon: appleMusicIcon,
    alt: "Apple Music",
    tip: "Из трека доступен только основной артист. Подписка спрятана в маленькой иконке, без подтверждения и объяснения. О том, что будут приходить уведомления, нигде не сказано.",
  },
  {
    name: "spotify",
    icon: spotifyIcon,
    alt: "Spotify",
    tip: "Если исполнителей несколько, выбрать нужного неудобно. После подписки появляется уведомление, что артист добавлен в библиотеку, но про релизы речи не идёт: уведомления настраиваются отдельно.",
  },
  {
    name: "soundcloud",
    icon: soundcloudIcon,
    alt: "SoundCloud",
    tip: "Единственный, кто прямо связывает подписку с уведомлениями о новых релизах. Но выбрать одного из нескольких исполнителей трека нельзя.",
  },
  {
    name: "vk-music",
    icon: vkMusicIcon,
    alt: "VK Музыка",
    tip: "Подписаться из трека нельзя, нужно уходить на страницу артиста. Ценность не объясняется, про уведомления о релизах ничего не сказано.",
  },
];
